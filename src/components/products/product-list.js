                ...
                <tr key={product.pid}>
                  ...
                  <td>
                    ...
                    <div style={{ margin: 10 }}>
                      ...
                      <Link
                        to={{
                          pathname: `${ROUTES.PRODUCT_LIST.path}/${
                            product.pid
                          }/edit`,
                          state: { product }
                        }}
                  ...
                  <td>{product.title}</td>
                  <td>
                    List Price : {product.listPrice} Discount :{' '}
                    {product.discount} Tax Percent: {product.taxPercent}{' '}
                    isInclusiveTax:{product.isInclusiveTax.toString()}
                  </td>
                  <td>{product.gender}</td>
                  <td>{JSON.stringify(product.description)}</td>
                  <td
                    dangerouslySetInnerHTML={{
                      __html:
                        '<pre>' +
                  ...
                  <td
                    dangerouslySetInnerHTML={{
                      __html:
                        '<pre>' +
                        JSON.stringify(product.collections, null, 2) +
                        '</pre>'
                    }}
                  />
                  ...
                  <td
                    dangerouslySetInnerHTML={{
                      __html:
                        '<pre>' +
                        JSON.stringify(product.assets, null, 2) +
                        '</pre>'
                    }}
                  />
