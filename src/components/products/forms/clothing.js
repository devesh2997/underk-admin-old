...
class ClothingForm extends Component {
  ...
  componentDidMount () {
    ...
    this.getSizes = this.props.firebase
      ...
      .onSnapshot(snapshot => {
        ...
        snapshot.forEach(doc => sizeOptions.push({ ...doc.data(), id: doc.id }))
  ...
  onSizeAdd = event => {
    ...
    let selectedSize = this.state.sizeOptions.find(
      option => option.id === this.state.currentSize
    )
  ...
  onSubmit = event => {
    ...
    let supp = this.props.suppliers.find(
      supp => supp.sid === product.supplier_id
    )
    ...
    this.props
      .handleSubmit(product, this.props.firebase)
      .then(() => {
  ...
  render () {
    ...
    const isInvalidForAddingSize =
      color === '' || style === '' || design === '' || isProductInvalid
          ...
          <Form onSubmit={this.onSubmit}>
            <FormGroup>
              ...
              >
                ...
                <option value='TP'>Topwear</option>
                <option value='BW'>Bottomwear</option>
            ...
            <div className='flex-card_container'>
              {Object.keys(sizes).map(size => (
                <SizeCard
                  ...
                  onQuantityChange={event =>
                    this.onPreviousQuantityChange(event, size)
                  }
              ...
              <SizeCard
                ...
                isActionBtnDisabled={
                  isSizeSelectionInvalid || isInvalidForAddingSize
                }
              />
            </div>
